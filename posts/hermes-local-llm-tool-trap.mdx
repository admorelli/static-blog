...
## The Current Stack: What's Next?

The local setup works. But I'm watching:

- **Llama 3.2 3B @ 2-bit** — fits 8GB, improving monthly
- **Mellum 2 12B** — when released
- **Nemotron 3 Ultra local** — distillation progress
- **Hermes MCP integration** — for niche tools on demand (not core)
